...
// Importamos o componente de pedidos que você acabou de criar
...
export default function AdminPage() {
  ...
  // NOVO ESTADO: Controla qual aba está ativa na tela (Produtos ou Pedidos)
    ...
    <div className="min-h-screen bg-gray-50 text-gray-800 p-4 sm:p-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <header className="flex flex-col sm:flex-row sm:items-center justify-between bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          <div>
            <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Painel El Roi</h1>
            <p className="text-sm text-gray-500 mt-1">Gerencie seu catálogo, estoque e acompanhe os pedidos.</p>
          </div>
        ...
        {/* NAVEGAÇÃO ENTRE ABAS (Produtos / Pedidos) */}
        <div className="flex gap-4 border-b border-gray-200 pb-2">
          <button
            onClick={() => setAbaAtiva('produtos')}
            className={`px-6 py-3 font-bold rounded-xl transition-all duration-300 ${
              abaAtiva === 'produtos' 
                ? 'bg-elroi-blue text-white shadow-md transform scale-105' 
        ...
        {/* ÁREA DE CONTEÚDO (Muda de acordo com a aba escolhida) */}
        {abaAtiva === 'produtos' ? (
          <>
            {/* SEÇÃO 1: FORMULÁRIO DE PRODUTOS */}
          ...
          /* SEÇÃO 3: TELA DE PEDIDOS (Aparece quando clica na aba de Pedidos) */
          <AdminPedidos />
        )}
